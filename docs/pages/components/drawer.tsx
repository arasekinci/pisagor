      ...
      <Example>
        ...
        <Drawer isOpen={open === 0} onClose={() => setOpen(-1)}>
          <p>
            ...
            consequuntur illum rem magni, distinctio similique pariatur
            voluptate eos, commodi vitae nisi mollitia impedit! Ad perspiciatis
            quod dolorum deserunt architecto!
          </p>
        </Drawer>
      </Example>
      <h4>Actions</h4>
