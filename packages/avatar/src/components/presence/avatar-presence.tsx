...
import { icon, background } from '@pisagor/core/tokens'
  ...
  const renderPresence = () => {
    switch (presence) {
      case 'busy':
        return (
          <Fragment>
            <circle fill={icon('error')} cx="4" cy="4" r="4" />
            <path
              fill={background()}
      ...
      case 'offline':
        return (
          <Fragment>
            ...
            />
            <path
              fill={background('accent.neutral.light')}
      ...
      case 'online':
        return <circle fill={icon('accent.green')} cx="4" cy="4" r="4" />
    }
  }
